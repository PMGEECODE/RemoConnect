    ...
    ModalDrawerSheet(
        ...
        Column(
            ...
            Column(
                ...
                // External Resources Section (Consolidated)
                PaddingText(text = "RESOURCES & LINKS")

                NavigationDrawerItem(
                    label = { Text("GitHub & Documentation") },
                    icon = { Icon(Icons.AutoMirrored.Filled.HelpOutline, contentDescription = null) },
                    selected = false,
                    onClick = {
                        val intent = Intent(
                            Intent.ACTION_VIEW,
                            Uri.parse("https://github.com/PMGEECODE/RemoConnect")
                        )
            ...
            // Fixed Footer at bottom of Sidebar Sheet
            HorizontalDivider(color = Color(0xFF2C324B))
            Box(
                modifier = Modifier
                    .fillMaxWidth()
